...
class GetMapCloudRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetMapCloudRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetMapCloudRequest
    let len;
    let data = new GetMapCloudRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMapCloudRequest(null);
    return resolved;
    }
};

class GetMapCloudResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetMapCloudResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetMapCloudResponse
    let len;
    let data = new GetMapCloudResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetMapCloudResponse(null);
...
module.exports = {
  Request: GetMapCloudRequest,
  Response: GetMapCloudResponse,
  md5sum() { return '40b2d5c19b1ba0f3eae539bbfbf252ac'; },
  datatype() { return 'vgn/GetMapCloud'; }
};
